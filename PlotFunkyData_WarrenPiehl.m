...
y = [women_apple women_pc; men_apple men_pc];
a3=subplot(2,2,3)
bar(y,'stacked')
hold on
...
subplot(1,3,3)
plot([data{:,gaming_header}], [data{:,sleep_header}],'ko');
xlabel('Gaming hours')
ylabel('sleep')
...
figure(3);
plot3([data{:,gaming_header}], [data{:,facebook_header}], [data{:,sleep_header}], 'ko');
zlabel('Sleep')
xlabel('Gaming hours')
...
plot([data{:,sleep_header}], [data{:,GPA_header}],'ko');
